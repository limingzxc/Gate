...
public abstract class Gate extends RedstoneDiodeBlock {
    ...
    protected Gate(Properties p_i48416_1_) {
        super(p_i48416_1_);
    }
    ...
    protected boolean shouldTurnOn(World world, BlockPos pos, BlockState state) {
        ...
        boolean flag1 = getLogic(i[0], i[1]);
    ...
    protected abstract boolean getLogic(boolean x, boolean y);
}
